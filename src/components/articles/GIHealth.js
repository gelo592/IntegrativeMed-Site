...
const GIArticle = ({ classes }) => (
  <div>
    <Typography className={classes.para}> 
      ...
      <ul>
        <li><Typography className={classes.para}> Are you making time to relax, and chew, when you eat?</Typography></li>
        <li><Typography className={classes.para}> Are you eating a balanced diet?</Typography></li>
        <li><Typography className={classes.para}> Are you limiting processed foods?</Typography></li>
        <li><Typography className={classes.para}> Are you regularly eating foods that you may be sensitive to – common offenders include wheat, dairy, eggs, sugar?</Typography></li>
        <li><Typography className={classes.para}> Are you drinking too much alcohol?</Typography></li>
      </ul>
    </Typography>
    <Typography className={classes.para}> 
    ...
    <Typography className={classes.para}> 
     ...
     <Typography className={classes.para}> 
      ...
      <ul>
        <li><Typography className={classes.para}> Eat your evening meal as early as possible, preferably at least 3 hours before bed.
        Going to bed soon after eating increases the potential for food to reflux from the
        stomach into the esophagus causing heartburn.</Typography></li>
        <li><Typography className={classes.para}> Many Americans eat their largest meal in the evening; other cultures eat the
        largest meal at noon. Eating larger meals early in the day can be very helpful.</Typography></li>
        <li><Typography className={classes.para}> Limit packaged and processed foods because they contain unhealthy fats and
        carbohydrates, which are a frequent cause of reflux.</Typography></li>
        <li><Typography className={classes.para}> Reduce or eliminate alcohol. If you choose to have alcohol limit it to 1 or 2
        servings with your meal and no alcohol 3 hours before bed. Alcohol opens the
        valve between the stomach and the esophagus, which encourages reflux.</Typography></li>
        <li><Typography className={classes.para}> Wheat, dairy, corn, and sugar are common food sensitivities and a common
        ...
        individually to see which one may be the offender.</Typography></li>
      </ul>
    <Typography className={classes.para}> 
      ...
      <ul>
        <li><Typography className={classes.para}> Start by taking the medication every other day. On the days off the PPI use
        Pepcid/famotidine, 20mg, this is an acid reducer too, but less powerful. It is
        available without prescription at most pharmacies.</Typography></li>
        <li><Typography className={classes.para}> Then, when doing well, in about two weeks, decrease the PPI to every third day,
        and then after a few weeks more, decrease to every fourth day, while continuing
        to use the Pepcid/famotidine on each of the intervening days.</Typography></li>
        <li><Typography className={classes.para}> Eventually, after 6 – 8 weeks you will be off the PPI safely. Finally, when feeling
        well, one can wean the Pepcid/famotidine.</Typography></li>
        <li><Typography className={classes.para}> Tums (Calcium carbonate) can be used as needed for occasional heartburn
        symptoms during or after weaning from the PPI.</Typography></li>
      </ul>
    <Typography className={classes.para}> 
