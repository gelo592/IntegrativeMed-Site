...
const SugarArticle = ({ classes }) => (
  <div>
    ...
    <Typography className={classes.para}> 
      ...
      <ul>
        <li><Typography className={classes.para}> 
          Website – <a className={classes.link} href={'http://nutritiondata.self.com/'}>http://nutritiondata.self.com/</a>
        </Typography></li>
        <li><Typography className={classes.para}> 
          Website and smart phone application – <a className={classes.link} href={'https://www.myfitnesspal.com/'}>https://www.myfitnesspal.com/</a>
        </Typography></li>
      </ul>
    <Typography className={classes.para}> 
